                        ...
                        <div class="col-xs-6">
                            ...
                            <form method="POST" action="">
                                <div class="form-group">
                                    ...
                                    <input id="demo" name="category" type="text" class="form-control" aria-describedby="emailHelp" value="xyz">
                                    <!-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> -->
                                </div>
                            ...
                            <table class="table table-striped table-hover table-responsive">
                                ...
                                <tbody>
                                    ...
                                    if (!$fetch_cat_result) {
                                        ...
                                        <td><a onclick='valueToInput(\"{$cat_title}\")' href='#'>Edit    </a></td>
                                    </tr>
                                            ";
                                        }
                                    }
                                ...
                                <!-- <td><a onclick='pashm("pashmaloo hastam mashti")' href='#'>Edit</a></td> -->
                            </table>
                        </div>
                    </div>
